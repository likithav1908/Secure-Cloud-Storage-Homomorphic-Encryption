...
<html>
    ...
    <body>
        ...
        <div class="container1">
            <h1 style="margin-left: 200px;">RequestCloud</h1>
            <table class="table table-bordered bg-white">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%= email%></td>
                        <td><%= file%></td>
                        <td><a href='Request_File.jsp?id=<%=id%>&name=<%= name%>&email=<%= email%>&file=<%= file%>'><button style="border-radius: 5px;">Request</button></a></td>
